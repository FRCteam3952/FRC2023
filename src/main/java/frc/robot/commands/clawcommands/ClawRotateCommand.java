...
public class ClawRotateCommand extends CommandBase {
    ...
    @Override
    public void execute() {
        if (this.joystick.getRawButtonWrapper(Constants.OperatorConstants.ControllerConstants.CLAW_ROTATE_RIGHT_BUTTON_NUMBER)) {
            this.claw.setClawRotateSpeed(ClawConstants.CLAW_ROTATE_SPEED);
        } else if (this.joystick.getRawButtonWrapper(Constants.OperatorConstants.ControllerConstants.CLAW_ROTATE_LEFT_BUTTON_NUMBER)) {
            this.claw.setClawRotateSpeed(-ClawConstants.CLAW_ROTATE_SPEED);
        } else {
